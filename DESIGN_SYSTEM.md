...
--shadow-focus:
  0 0 0 2px rgba(255, 45, 85, 0.4), 0 0 16px rgba(255, 45, 85, 0.15);
--shadow-glow:
  0 0 20px rgba(255, 45, 85, 0.25), 0 0 60px rgba(255, 45, 85, 0.08);
--shadow-neon:
  0 0 6px rgba(255, 45, 85, 0.45), 0 0 20px rgba(255, 45, 85, 0.15),
  0 0 40px rgba(255, 45, 85, 0.05);
--shadow-card: 0 2px 8px rgba(0, 0, 0, 0.4), 0 0 1px rgba(255, 45, 85, 0.08);
--shadow-card-hover:
  0 8px 32px rgba(0, 0, 0, 0.45), 0 0 12px rgba(255, 45, 85, 0.1);
```
...
```html
<html data-theme="dark" data-color="runner"></html>
```
...
3. **Set the theme** on your HTML root:
   ```html
   <html data-theme="dark" data-color="ocean"></html>
   ```
